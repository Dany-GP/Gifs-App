// To parse this data:
//
//   import { Convert, SeacrhGIFResponse } from "./file";
//
//   const seacrhGIFResponse = Convert.toSeacrhGIFResponse(json);
//
...
export class Convert {
    public static toSeacrhGIFResponse(json: string): SearchGIFResponse {
        return cast(JSON.parse(json), r("SeacrhGIFResponse"));
    }

    public static seacrhGIFResponseToJson(value: SearchGIFResponse): string {
        return JSON.stringify(uncast(value, r("SeacrhGIFResponse")), null, 2);
    }
}
